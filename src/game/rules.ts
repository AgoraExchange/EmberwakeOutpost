...
export function createDefaultSave(): SaveData {
  return {
    ...
    station: { cookMeals: 0, rawMeat: 0, meals: 0, rawFish: 0, fishMeals: 0, butcherProgress: 0, fishProgress: 0, fisherProgress: 0, oreProgress: 0, lumber: 0, lumberProgress: 0, hunterProgress: 0, passiveCash: 0 },
    tutorial: 'move',
