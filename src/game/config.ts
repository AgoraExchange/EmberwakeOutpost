...
export const UPGRADES: UpgradeConfig[] = [
  ...
  { id: 'robots', label: 'Robot Foundry', icon: '⚙', description: 'Build robots and tap them nearby to assign work', baseCost: 1800, costScale: 2.2, maxLevel: 3, effectText: l => l === 0 ? 'No robots' : `${l * 2} assignable robots · 3.5× yield / plate capacity` },
